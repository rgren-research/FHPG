...
from .ptq.layers import QConv2d, QLinear, QAct, QIntSoftmax, QIntLayerNorm
from .layers_quant import HybridEmbed, PatchEmbed, DropPath, Mlp, trunc_normal_
# from .ptq import QAct,  QIntLayerNorm, QIntSoftmax, QLinear
# __all__ = [
#     'deit_tiny_patch16_224', 'deit_small_patch16_224', 'deit_base_patch16_224',
#     'vit_base_patch16_224', 'vit_large_patch16_224'
# ]
__all__ = ['quant_deit_base_patch16_224']
...
def quant_deit_base_patch16_224(pretrained=False,
                          quant=False,
                          calibrate=False,
                          cfg=None,
                          **kwargs):
    ...
    pruned_model_path = '/FHPG/FHPG-main/output/pruned_model_weights-0717.pth'
    if pretrained and pruned_model_path is not None:
        # Load locally pruned model weights
        checkpoint = torch.load(pruned_model_path, map_location='cpu')
        # model.load_state_dict(checkpoint['model'], strict=False) # The original code was set to False.

        model.load_state_dict(checkpoint, strict=False)  # strict=True  Indicates the strict mode loading weight
        # This will allow the model to load all matching weights and ignore those redundant keys.
        # model.load_state_dict(checkpoint['model'], strict=False)
    return model
